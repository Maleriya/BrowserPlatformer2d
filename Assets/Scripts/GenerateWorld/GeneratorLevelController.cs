...
namespace Platformer.GenerateWorld
{
    public class GeneratorLevelController
    {
        ...
        public void Update(GenerateLevelView generateLevelView)
        {
            if(generateLevelView.FactorSmooth != _factorSmooth || generateLevelView.RandomFillPercent != _randomFillPercent)
            {
                _factorSmooth = generateLevelView.FactorSmooth;
                _randomFillPercent = generateLevelView.RandomFillPercent;
                ClearLevel();
                // GenerateLevel();
                GenerateMarchingLevel();
            }
        }
        ...
        private void GenerateMarchingLevel()
        {
            RandomFillLevel();
